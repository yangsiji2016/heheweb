...
(function (a, b) {
    ...
    f.extend({
        ...
        p.setAttribute("className", "t"), p.innerHTML = "   <link/><table></table><a href='http://www.aetoscg.com/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>", d = p.getElementsByTagName("*"), e = p.getElementsByTagName("a")[0];
