...
(function(d) {
	function l(a, c) {
		...
		d.browser.msie && d(".wowbook-handle", a).css({
			backgroundColor: "#fff",
			opacity: "http://www.aetoscg.com/cn/static/js/0.01"
		});
	...
	l.prototype = {
		...
		initThumbnails: function() {
			var a = this.opts;
			this.thumbnails = [];
			var c = this.thumbnailsContainer = d("<div class='wowbook-thumbnails'>").append("<div id='ebClose'>×</div><div class='wowbook-wrapper'><div class='wowbook-back wowbook-button' /><div class='wowbook-clipper'><ul></ul></div><div class='wowbook-next wowbook-button' /></div>").css("display", "none").css("transform", "translateZ(0)").appendTo(d(a.thumbnailsParent));
	...
	d.wowBook.defaults = {
		...
		onZoom: null,
		flipSound: !0,
		flipSoundFile: ["http://www.aetoscg.com/cn/static/js/page-flip.mp3", "http://www.aetoscg.com/cn/static/js/page-flip.ogg"],
		flipSoundPath: "./sound/",
...
(function(d) {
	...
	if (d.cssHooks) {
		...
		d.wowBook.applyAlphaImageLoader = function(l) {
			...
			s = 0;
			for (n = l.length; s < n; s++) if (u = l[s], B.addClass(u), g = B.css("background-image").match(/^url\("(.*)"\)$/)) w += "." + u + "{background:none; filter : progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + g[1] + "', sizingMethod='scale'); } ", B.removeClass(u);
